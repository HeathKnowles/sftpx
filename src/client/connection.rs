...
impl ClientConnection {
    pub fn new(
        ...
        quic_config.set_initial_max_data(10_000_000_000);  // 10GB connection window
        quic_config.set_initial_max_stream_data_bidi_local(1_000_000_000);  // 1GB per stream
        quic_config.set_initial_max_stream_data_bidi_remote(1_000_000_000);  // 1GB per stream
        ...
        // Moderate initial congestion window
        quic_config.set_initial_congestion_window_packets(50);
